...
namespace assembler
{
	...
	{
	public:
		console(core::gfx::graphics_backend backend, core::resource::handle<core::data::window> window_data = {}) : m_Cache(psl::meta::library(utility::application::path::library + "resources.metalib", { psl::to_string(backend) }))
		{
